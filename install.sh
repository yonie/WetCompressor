#!/bin/bash
echo "================================================"
echo " WetCompressor VST3 Plugin - Installation"
echo "================================================"
echo ""
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    if [ -d "WetCompressor/build/Release/WetCompressor.vst3" ]; then
        PLUGIN_SOURCE="WetCompressor/build/Release/WetCompressor.vst3"
    else
        PLUGIN_SOURCE="WetCompressor/build/VST3/Release/WetCompressor.vst3"
    fi
...
echo "Installing WetCompressor.vst3 to $PLUGIN_DEST..."
...
if [[ "$PLATFORM" == "macOS" ]]; then
    ...
    xattr -cr "$PLUGIN_DEST/WetCompressor.vst3" 2>/dev/null || true
fi
...
echo "================================================"
echo ""
echo "Plugin installed to: $PLUGIN_DEST/WetCompressor.vst3"
echo ""
...
echo "3. Look for WetCompressor in your plugin list"
echo ""
