@echo off
echo ================================================
echo  WetCompressor VST3 Plugin - Install Script
echo ================================================
echo.

set VST3_PATH=%COMMONPROGRAMFILES%\VST3
set PLUGIN_PATH=WetCompressor\build\VST3\Release\WetCompressor.vst3
...
if exist "%VST3_PATH%\WetCompressor.vst3" (
    echo Removing old installation...
    rmdir /S /Q "%VST3_PATH%\WetCompressor.vst3"
)

REM Copy the plugin
echo Copying plugin files...
xcopy /E /Y /I "%PLUGIN_PATH%" "%VST3_PATH%\WetCompressor.vst3\"
if errorlevel 1 (
...
echo ================================================
echo.
echo Plugin installed to: %VST3_PATH%\WetCompressor.vst3
echo.
